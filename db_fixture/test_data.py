...
datas= {
    'sign_event':[
        ...
        {'id':2,'name':'可参加','`limit`':0,'status':1,
         'address':'北京会展中心','start_time':'2017-08-20 14:00:00'},
        {'id':3,'name':'当前状态为0关闭','`limit`':2000,'status':0,
         'address':'北京会展中心','start_time':'2017-08-20 14:00:00'},
        {'id':4,'name':'发布会已结束','`limit`':2000,'status':1,
         'address':'北京会展中心','start_time':'2009-08-20 14:00:00'},
        {'id':5,'name':'红米Pro发布会','`limit`':2000,'status':1,
         'address':'北京国家会展中心','start_time':'2017-08-20 14:00:00'}
    ],
    'sign_guest':[
